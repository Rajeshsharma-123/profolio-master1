...
export const metadata: Metadata = {
  ...
  title: 'Terms and Conditions — Rajesh',
  description:
        ...
        <ul className='list-outside list-disc block ml-10'>
          ...
          <li className='list-item'>
            <p className='mb-4 text-base'>
              ...
              in this Agreement) refers to Rajesh.
            </p>
          </li>
          <li className='list-item'>
            <p className='mb-4 text-base'>
          ...
          <li className='list-item'>
            <p className='mb-4 text-base'>
              <strong>Website</strong> refers to Rajesh, accessible from{' '}
              <a
                href='https://www.Rajesh.my'
        ...
        <ul className='list-outside list-disc block ml-10'>
          ...
          <li className='list-item'>
            <p className='mb-4 text-base'>
              ...
              <Link
                href='https://www.Rajesh.my#contact'
                className='font-medium hover:underline underline-offset-4'
                rel='external nofollow noopener'
                target='_blank'
              >
